...
## Summary
CGM support for T1 & T2 diabetics w/ dexcom and abbott libre devices 🦾
...
## Intake forms 
### Onboarding form
Bionic is a new support service for people who use CGMs. In order to join, we’ll need to ask you a few questions about your medical background, why you're requesting a CGM, and some other basic information. To start, when were you first diagnosed with diabetes? <br/>
*(Single choice)*
- [ ] Recently
- [ ] 3-6 months ago
- [ ] 6 months to 2 years ago
- [ ] Greater than 2 years
- [ ] I don’t have diabetes, I just want a CGM
